...
public class QueueController(AzureServiceBusQueueService serviceBusDemoService) : Controller
{
    private readonly AzureServiceBusQueueService _serviceBusDemoService = serviceBusDemoService;
